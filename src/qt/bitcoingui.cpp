 ...
 * The Minermind Developers 2011-2013
 */
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Minermind address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/minermind_tooltip"), tr("&About Minermind"), this);
    aboutAction->setToolTip(tr("Show information about Minermind"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Minermind"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/minermind_tooltip"), tr("Show/Hide &Minermind"), this);
    toggleHideAction->setToolTip(tr("Show or hide the Minermind window"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        if(clientModel->isTestNet())
        {
            ...
            setWindowIcon(QIcon(":icons/minermind_icon"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/minermind_icon"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(title_testnet);
                trayIcon->setIcon(QIcon(":/icons/minermind_tooltip"));
            }
        }
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Minermind client"));
    trayIcon->setIcon(QIcon(":/icons/minermind_tooltip"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Minermind network", "", count));
}
