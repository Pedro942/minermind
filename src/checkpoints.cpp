...
namespace Checkpoints
{
    ...
    // minermind: synchronized checkpoint (centrally broadcasted)
    ...
    // minermind: get last synchronized checkpoint
    ...
    // minermind: only descendant of current sync-checkpoint is allowed
    ...
    // minermind: reset synchronized checkpoint to last hardened checkpoint
...
// minermind: sync-checkpoint master key
...
// minermind: verify signature of sync-checkpoint message
...
// minermind: process synchronized checkpoint
