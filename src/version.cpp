...
// Copyright (c) 2014 The Minermind developers
...
// for both minermindd and minermind(-qt), to make it harder for attackers to
// target servers or GUI users specifically.

// For the current run of Minermind releases, the client name should be selected from
