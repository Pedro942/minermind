...
// Copyright (c) 2011-2015 The Minermind developers
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Minermind " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
// testnet dns seed begins with 't', all else are minermind dns seeds.
static const char *strDNSSeed[][2] = {
        {"seed", "seed.minermindcoin.org"},
        {"seed2", "seed2.minermindcoin.org"},
        {"seed3", "seed3.minermindcoin.org"},
        {"seed4", "seed4.minermindcoin.org"},
        {"seed5", "seed5.minermindcoin.org"},
        {"seed6", "seed6.minermindcoin.org"},
        {"seed7", "seed7.minermindcoin.org"},
};
...
void ThreadDNSAddressSeed2(void* parg)
{
    ...
    if (true /*!fTestNet*/)  // minermind enables dns seeding with testnet too
    {
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer.  Minermind is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    // minermind: mint proof-of-stake blocks in the background
